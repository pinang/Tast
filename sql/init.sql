...
CREATE TABLE IF NOT EXISTS `StockHistory` (
  ...
  `PrevHistoryId` char(32) DEFAULT NULL COMMENT '前一天编号',
  `Code` varchar(10) NOT NULL COMMENT '股票编号',
  `Date` char(8) NOT NULL COMMENT '日期',
  `PrevDate` char(8) DEFAULT NULL COMMENT '上一个日期',
...
CREATE TABLE IF NOT EXISTS `TurtleTradingSystem` (
  ...
  `Code` varchar(10) NOT NULL COMMENT '股票编号',
  `StartAmount` decimal(20,4) NOT NULL COMMENT '起始资金',
  `Commission` decimal(20,4) NOT NULL COMMENT '佣金',
  ...
  `CurrentProfit` decimal(20,4) NOT NULL COMMENT '当前利润额',
  `CurrentProfitPercent` decimal(20,4) NOT NULL COMMENT '当前利润率',
  ...
  `BestProfit` decimal(20,4) NOT NULL COMMENT '最佳利润额',
  `BestProfitPercent` decimal(20,4) NOT NULL COMMENT '最佳利润率',
  ...
  `PassedSeconds` bigint(20) NOT NULL COMMENT '已经运行的时间',
...
CREATE TABLE IF NOT EXISTS `TurtleTradingSystemHolding` (
  ...
  `StartPrice` decimal(20,4) NOT NULL COMMENT '开始价格',
  `EndDate` char(8) NOT NULL COMMENT '结束日期',
  `EndPrice` decimal(20,4) NOT NULL COMMENT '结束价格',
  `Quantity` int(11) NOT NULL COMMENT '数量',
  `Profit` decimal(20,4) NOT NULL COMMENT '利润',
...
CREATE TABLE IF NOT EXISTS `TurtleTradingSystemTest` (
  ...
  `StartAmount` decimal(20,4) NOT NULL COMMENT '起始资金量',
  `EndAmount` decimal(20,4) NOT NULL COMMENT '结束资金量',
  `Commission` decimal(20,4) NOT NULL COMMENT '佣金',
  `Profit` decimal(20,4) NOT NULL COMMENT '利润额',
  `ProfitPercent` decimal(20,4) NOT NULL COMMENT '利润率',
  PRIMARY KEY (`TestId`),
